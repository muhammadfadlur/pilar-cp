	<div class="row">
	    <div class="col-xs-12">
	        <div class="box box-primary">
                ...
                <h3 class="box-title">Sub Layanan</h3>
                <span class="box-title pull-right">
                	<a href="<?php echo site_url('admin_sub_layanan/add')?>" class="btn btn-xs btn-primary btn-flat"><i class="ion-plus-round"></i>&nbsp;&nbsp;Tambah</button></a>
                </span>
                <div class="box-tools box-cari">
                <?=form_open('admin_berita/cari')?>
									...
									<tr>
										...
										<td>
											...
											<span class="pull-right">
												<?php echo anchor('admin_sub_layanan/detail/'.$row['id_sub_layanan'].'','Lihat','class="label label-primary" title="Lihat detail data jadwal"'); ?>
												<?php echo anchor('admin_sub_layanan/edit/'.$row['id_sub_layanan'].'','Edit','class="label label-warning" title="Edit data jadwal"'); ?>
												<?php echo anchor('admin_sub_layanan/delete/'.$row['id_sub_layanan'].'','Hapus','class="label label-danger" title="Hapus data jadwal" onClick="return confirm(\'Yakin ingin menghapus '.$row['judul'].' dari data master Jadwal?\');"'); ?>
											</span>
										</td>
									</tr>
									<?php 
