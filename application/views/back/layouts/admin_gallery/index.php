	    ...
	    <div class="col-xs-12">
	        <div class="box box-primary">
                ...
                <span class="box-title pull-right">
                	<a href="<?php echo site_url('admin_gallery/add')?>" class="btn btn-xs btn-primary btn-flat"><i class="ion-plus-round"></i>&nbsp;&nbsp;Tambah</button></a>
                </span>
                <div class="box-tools box-cari">
                <?=form_open('admin_slider/cari')?>
                ...
                <table class="table table-hover table-condensed table-striped">
									...
									<tr>
										...
										<td width="15%"><?php echo $row['judul']?></td>
										
										<td>
											
											<span class="pull-right">
												<?php echo anchor('admin_gallery/detail/'.$row['id_gallery'].'','Lihat','class="label label-primary" title="Lihat detail data Gallery"'); ?>
												<?php echo anchor('admin_gallery/edit/'.$row['id_gallery'].'','Edit','class="label label-warning" title="Edit data Gallery"'); ?>
												<?php echo anchor('admin_gallery/delete/'.$row['id_gallery'].'','Hapus','class="label label-danger" title="Hapus data Gallery" onClick="return confirm(\'Yakin ingin menghapus '.$row['judul'].' dari data master Gallery?\');"'); ?>
											</span>
										</td>
									</tr>
									<?php 
