	    ...
	    <div class="col-xs-12">
	        <div class="box box-primary">
                ...
                <span class="box-title pull-right">
                	<a href="<?php echo site_url('admin_jadwal/add')?>" class="btn btn-xs btn-primary btn-flat"><i class="ion-plus-round"></i>&nbsp;&nbsp;Tambah</button></a>
                </span>
                ...
                <table class="table table-hover table-condensed table-striped">
									...
									<tr>
										...
										<td width="15%"><?php echo $row['nama_kegiatan']?></td>
										<td width="20%"><?php echo $row['tgl_mulai']?></td>
										<td>
											<?php echo $row['tgl_selesai']?>
											<span class="pull-right">
												<?php echo anchor('admin_jadwal/detail/'.$row['id_jadwal'].'','Lihat','class="label label-primary" title="Lihat detail data jadwal"'); ?>
												<?php echo anchor('admin_jadwal/edit/'.$row['id_jadwal'].'','Edit','class="label label-warning" title="Edit data jadwal"'); ?>
												<?php echo anchor('admin_jadwal/delete/'.$row['id_jadwal'].'','Hapus','class="label label-danger" title="Hapus data jadwal" onClick="return confirm(\'Yakin ingin menghapus '.$row['nama_kegiatan'].' dari data master Jadwal?\');"'); ?>
											</span>
										</td>
									</tr>
									<?php 
