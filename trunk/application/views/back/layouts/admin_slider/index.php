	    ...
	    <div class="col-xs-12">
	        <div class="box box-primary">
                ...
                <span class="box-title pull-right">
                	<a href="<?php echo site_url('admin_slider/add')?>" class="btn btn-xs btn-primary btn-flat"><i class="ion-plus-round"></i>&nbsp;&nbsp;Tambah</button></a>
                </span>
									...
									<tr>
										...
										<td>
											...
											<span class="pull-right">
												<?php echo anchor('admin_slider/detail/'.$row['id_slider'].'','Lihat','class="label label-primary" title="Lihat detail data Slider"'); ?>
												<?php echo anchor('admin_slider/edit/'.$row['id_slider'].'','Edit','class="label label-warning" title="Edit data Slider"'); ?>
												<?php echo anchor('admin_slider/delete/'.$row['id_slider'].'','Hapus','class="label label-danger" title="Hapus data Slider" onClick="return confirm(\'Yakin ingin menghapus '.$row['judul'].' dari data master Slider?\');"'); ?>
											</span>
										</td>
									</tr>
									<?php 
