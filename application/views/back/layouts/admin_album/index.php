	    ...
	    <div class="col-xs-12">
	        <div class="box box-primary">
                ...
                <span class="box-title pull-right">
                	<a href="<?php echo site_url('admin_album/add')?>" class="btn btn-xs btn-primary btn-flat"><i class="ion-plus-round"></i>&nbsp;&nbsp;Tambah</button></a>
                </span>
                ...
                <table class="table table-hover table-condensed table-striped">
									...
									<tr>
										...
										<td width="15%"><?php echo $row['album']?></td>
										
										<td>
											
											<span class="pull-right">
												<?php echo anchor('admin_album/detail/'.$row['id_album'].'','Lihat','class="label label-primary" title="Lihat detail data Album"'); ?>
												<?php echo anchor('admin_album/edit/'.$row['id_album'].'','Edit','class="label label-warning" title="Edit data Album"'); ?>
												<?php echo anchor('admin_album/delete/'.$row['id_album'].'','Hapus','class="label label-danger" title="Hapus data Album" onClick="return confirm(\'Yakin ingin menghapus '.$row['album'].' dari data master Album?\');"'); ?>
											</span>
										</td>
									</tr>
									<?php 
