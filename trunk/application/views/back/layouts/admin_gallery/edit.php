		<div class="row">
		    <div class="col-xs-12">
		        <div class="box box-primary">
		            ...
		            <?=form_open_multipart('admin_gallery/update', array('role' => 'form', 'id' => 'form')); 
									if(!empty($list)){
								?>
		            <div class="box-body">				        
						<input type="hidden" name="id_gallery" value="<?=$list['id_gallery']?>" />
					...
					<div class="form-group">
							...
							echo form_dropdown('album',$list_album,$list['id_album'],$js);
							?>
						</div>
						<div class="form-group">
						  <label>Gambar</label>
						  <div>
						  <?php
						  $path_gambar=base_url()."foto_gallery/".$list['gambar'];
						  ?>
