	    ...
	    <div class="col-xs-12">
	        <div class="box box-primary">
                ...
                <span class="box-title pull-right">
                	<a href="<?php echo site_url('admin_berita/add')?>" class="btn btn-xs btn-primary btn-flat"><i class="ion-plus-round"></i>&nbsp;&nbsp;Tambah</button></a>
                </span>
									...
									<tr>
										...
										<td>
											...
											<span class="pull-right">
												<?php echo anchor('admin_berita/detail/'.$row['id_berita'].'','Lihat','class="label label-primary" title="Lihat detail data jadwal"'); ?>
												<?php echo anchor('admin_berita/edit/'.$row['id_berita'].'','Edit','class="label label-warning" title="Edit data jadwal"'); ?>
												<?php echo anchor('admin_berita/delete/'.$row['id_berita'].'','Hapus','class="label label-danger" title="Hapus data jadwal" onClick="return confirm(\'Yakin ingin menghapus '.$row['judul'].' dari data master Jadwal?\');"'); ?>
											</span>
										</td>
									</tr>
									<?php 
